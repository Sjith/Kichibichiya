...
import static com.pahans.kichibichiya.util.Utils.cancelRetweet;
import static com.pahans.kichibichiya.util.Utils.clearUserColor;
import static com.pahans.kichibichiya.util.Utils.findStatus;
...
import static com.pahans.kichibichiya.util.Utils.getImagesInStatus;
import static com.pahans.kichibichiya.util.Utils.getQuoteStatus;
...
import static com.pahans.kichibichiya.util.Utils.isMyActivatedAccount;
import static com.pahans.kichibichiya.util.Utils.isMyRetweet;
...
import static com.pahans.kichibichiya.util.Utils.setMenuForStatus;
import static com.pahans.kichibichiya.util.Utils.setUserColor;
import static com.pahans.kichibichiya.util.Utils.showErrorToast;
...
import com.pahans.kichibichiya.adapter.ParcelableStatusesAdapter;
import com.pahans.kichibichiya.app.TwidereApplication;
import com.pahans.kichibichiya.loader.DummyParcelableStatusesLoader;
import com.pahans.kichibichiya.model.ImageSpec;
import com.pahans.kichibichiya.model.Panes;
import com.pahans.kichibichiya.model.ParcelableLocation;
...
import com.pahans.kichibichiya.util.ClipboardUtils;
import com.pahans.kichibichiya.util.HtmlEscapeHelper;
...
public class StatusFragment extends ParcelableStatusesListFragment implements OnClickListener, Panes.Right,
	...
	private TextView mScreenNameView, mTimeAndSourceView, mInReplyToView, mLocationView,
			mRetweetedStatusView;
	private SCTextView mNameView,mTextView;
	...
	public void displayStatus(final ParcelableStatus status) {
		...
		mNameView.setText(SinhalaDroid.convert(status.name));
	...
	public View onCreateView(final LayoutInflater inflater, final ViewGroup container, final Bundle savedInstanceState) {
		...
		mNameView = (SCTextView) mStatusView.findViewById(R.id.name);
		mScreenNameView = (TextView) mStatusView.findViewById(R.id.screen_name);
		mTextView = (SCTextView) mStatusView.findViewById(R.id.text);
